...
const socialMediaIcons = [
  { name: 'Behance', src: '/soical media/Behance.svg' },
  { name: 'Instagram', src: '/soical media/Instagram.svg' },
  { name: 'LinkedIn', src: '/soical media/LinkedIn.svg' },
  { name: 'Telegram', src: '/soical media/Telegram.svg' },
  { name: 'WhatsApp', src: '/soical media/WhatsApp.svg' },
  { name: 'YouTube', src: '/soical media/Youtube.svg' },
]
          ...
          <footer className="self-end lg:col-span-2 lg:col-start-1 lg:row-start-3">
            <div className="border-t border-gray-100 bg-gray-50 py-10 dark:border-white/10 dark:bg-gray-800/50">
              <nav className="mx-auto flex w-full max-w-7xl items-center gap-x-4 px-6 text-sm/7 text-gray-600 lg:px-8 dark:text-gray-400">
                ...
                {socialMediaIcons.map((icon) => (<Image key={icon.name} src={icon.src} alt={icon.name} width={32} height={32}/>))}
              </nav>
            </div>
          </footer>
